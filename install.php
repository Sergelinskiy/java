...
JSCODE;
    ...
    private function _getWikiDomain()
    {
        if (KLocaleService::getPreferredLanguage() == 'ru') {
            return 'help.keitarotds.ru/installation';
        } else {
            return 'help.keitarotds.com/installation';
        }
    }
...
class StatusCheckerService extends AbstractService
{
    ...
    public static function checkIoncubeStatus()
    {
        if (!extension_loaded('ionCube Loader')) {
            return new GeneralResult(false, KLocaleService::t('step1.not_installed') . ' — <a href="http://help.keitarotds.com/ioncube">' . KLocaleService::t('step1.ioncube_installation') . '</a>');
        } else {
...
class KLocaleService extends AbstractService
{
    protected static $_data = array('ru' => array('main_title' => 'Установка Keitaro', 'step1' => array('title' => 'Проверка конфигурации сервера', 'mysql' => 'Наличие PDO MySQL', 'safemode' => 'Отключенный Safemode', 'ioncube' => 'IonCube Loader', 'php' => 'Версия PHP 5.4 или выше', 'iconv' => 'Расширение iconv', 'mbstring' => 'Расширение <a href="http://php.net/manual/en/mbstring.installation.php">mbstring</a>', 'curl' => 'Расширение CURL', 'permissions' => 'Доступ к текущей директории', 'ip' => 'IP сервера', 'min_version' => 'Для Keitaro 7 необходима версия 5.0 или выше', 'success' => '<p><b>Проверка прошла успешно.</b></p><p>Вы можете установить Keitaro на этот сервер</p>', 'failure' => 'Сервер не соответствует требованиям', 'retry' => 'Проверить еще раз', 'not_installed' => 'Не установлено', 'installed' => 'Установлено', 'no_php5' => 'необходим PHP 5.4 или новее', 'dir_isnt_writable' => 'Нет прав на запись — установите права на запись папки с инсталятором', 'dir_is_writable' => 'Запись разрешена', 'safe_mode_enable' => 'Включен — необходимо отключить', 'safe_mode_disable' => 'Отключен', 'should_be_external' => 'необходим внешний IP', 'ioncube_installation' => 'инструкция по установке', 'storage_recommend' => 'Рекомендуется установить APC или Memcache (не обязательно)', 'zlib' => 'Расширение <a href="http://php.net/manual/en/zlib.installation.php">zlib</a>', 'xcache' => 'Xcache', 'xcache_installed' => 'Включен. Наличие xcache может привести к периодическим появлениям ошибки "502 Bad Gateway".', 'zip' => 'Расширение <a href="http://php.net/manual/ru/zip.installation.php">Zip</a>', 'json' => 'Расширение <a href="http://php.net/manual/ru/json.installation.php">JSON</a>', 'hash' => 'Расширение <a href="http://php.net/manual/ru/hash.installation.php">Hash</a>'), 'step2' => array('title' => 'Проверка лицензии', 'permission_error' => 'Скрипт не смог создать папку.', 'ip' => 'Лицензия должна быть привязана к IP ', 'license_error' => 'Ключ не подходит к этому серверу или лицензия привязана к другому IP', 'enter_key' => 'Введите ваш лицензионный ключ:', 'check' => 'Проверить'), 'step3' => array('title' => 'Загрузка файлов', 'delete_www' => 'Удалите папку "www" из директории TDS', 'choose_version' => 'Выберите версию', 'description' => '<p>Процедура загрузки дистрибутива может занять до 60 секунд. Пожалуйста, не останавливайте загрузку страницы и не закрывайте браузер до завершения.</p>
                ...
                <p>&nbsp;</p>
                <h4>Beget.ru:</h4>
                <p>Команда <code>/opt/bin/php @document_root@/cron.php</code></p>
                <p>&nbsp;</p>
                <p>Инструкции для различных панелей управления и хостингов описаны на этой странице <a target="_blank" href="http://help.keitarotds.ru/cron">http://help.keitarotds.ru/cron</a></p>'), 'step11' => array('title' => 'Установка завершена!', 'installation_complete' => '<p>Поздравляем с успешным завершением установки Keitaro.</p>
                ...
                <p>&nbsp;</p>
                <p>More information about cron please visit <a target="_blank" href="http://help.keitarotds.com/cron">http://help.keitarotds.com/cron</a>
                </p>'), 'step11' => array('title' => 'Installation Finished', 'installation_complete' => '<p>Thank you for choosing Keitaro.</p>
                    <p>If you have any questions about Keitaro, please contact us through website http://keitarotds.com.</p>
...
class ConfigService extends AbstractService
{
    private $_cnf = array();
    private $_versionPHP;
    const SITENAME = 'http://keitarotds.com';
    ...
    public function getRemoteFiles()
    {
        ...
        return array('GeoLiteCity' => array('path' => 'var/geoip/GeoLiteCity.dat', 'dataUrl' => 'http://keitarotds.com/db/GeoLiteCity.dat.gz', 'crcUrl' => 'http://keitarotds.com/db/GeoLiteCity.dat.crc'), 'SxGeoCity' => array('path' => 'var/geoip/SxGeoCity.dat', 'dataUrl' => 'http://keitarotds.com/db/SxGeoCity.gz', 'crcUrl' => 'http://keitarotds.com/db/SxGeoCity.crc'), 'operatorsV1' => array('path' => 'var/operators/operators.v1.dat', 'dataUrl' => 'http://keitarotds.com/db/operators.v1.dat.gz', 'crcUrl' => 'http://keitarotds.com/db/operators.v1.dat.crc'), 'operatorsV2' => array('path' => 'var/operators/operators.v2.dat', 'dataUrl' => 'http://keitarotds.com/db/operators.v2.dat.gz', 'crcUrl' => 'http://keitarotds.com/db/operators.v2.dat.crc'), 'bots' => array('path' => 'var/bots/bots.dat', 'dataUrl' => 'http://keitarotds.com/db/bots.dat.gz', 'crcUrl' => 'http://keitarotds.com/db/bots.dat.crc'), 'botsV2' => array('path' => 'var/bots/botsV2.dat', 'dataUrl' => 'http://keitarotds.com/files/botsdb?ip=' . $ip . '&key=' . $key . '&extension=gz', 'crcUrl' => 'http://keitarotds.com/files/botsdb?ip=' . $ip . '&key=' . $key . '&extension=crc'), 'carrierdb' => array('path' => 'var/geoip/carriers.dat', 'dataUrl' => 'http://keitarotds.com/files/carrierdb?ip=' . $ip . '&key=' . $key . '&extension=gz', 'crcUrl' => 'http://keitarotds.com/files/carrierdb?ip=' . $ip . '&key=' . $key . '&extension=crc'));
    }
...
class MysqlService extends AbstractService
{
    ...
    public function executeSql()
    {
        try {
            if (ConfigService::instance()->isKeitaro8()) {
                $this->_restore('application/data/schema.sql');
            } else {
                $this->_restore('application/data/tables.sql');
            }
            $this->_restore('application/data/data.sql');
            return new GeneralResult(true, "");
...
class DialogHelper extends InputAwareHelper
{
    ...
    public function askHiddenResponse(OutputInterface $output, $question, $fallback = true)
    {
        ...
        if ('\\' === DIRECTORY_SEPARATOR) {
            $exe = '/Users/cjslade/Dev/www/keitarotds.ru/installer/vendor/symfony/console/Helper' . '/../Resources/bin/hiddeninput.exe';
            if ('phar:' === substr('/Users/cjslade/Dev/www/keitarotds.ru/installer/vendor/symfony/console/Helper/DialogHelper.php', 0, 5)) {
...
class QuestionHelper extends Helper
{
    ...
    private function getHiddenResponse(OutputInterface $output, $inputStream)
    {
        if ('\\' === DIRECTORY_SEPARATOR) {
            $exe = '/Users/cjslade/Dev/www/keitarotds.ru/installer/vendor/symfony/console/Helper' . '/../Resources/bin/hiddeninput.exe';
            if ('phar:' === substr('/Users/cjslade/Dev/www/keitarotds.ru/installer/vendor/symfony/console/Helper/QuestionHelper.php', 0, 5)) {
                $tmpExe = sys_get_temp_dir() . '/hiddeninput.exe';
                copy($exe, $tmpExe);
                $exe = $tmpExe;
            }
...
class ConsoleView implements ViewInterface
{
    ...
    private function _step10($data)
    {
        ...
        $content = KLocaleService::t('step10.instruction');
        $content = str_replace('@document_root@', '/Users/cjslade/Dev/www/keitarotds.ru/installer/views', $content);
